...
// Sine wave SVG path (two full cycles so we can slide -50% seamlessly)
const WAVE_PATH =
  'M0 30 C50 10, 100 50, 150 30 S250 10, 300 30 S400 50, 450 30 S550 10, 600 30 S700 50, 750 30 S850 10, 900 30 S1000 50, 1050 30 S1150 10, 1200 30 V60 H0 Z';
...
export function HeroSection({ stats, totalOpportunities }: HeroSectionProps) {
  return (
    <section className="relative overflow-hidden py-12 sm:py-16 md:py-24">
      ...
      {/* ── Layer 2: Scan line sweeping hero ── */}
      <ScanLine />
      ...
      <div
        ...
        aria-hidden="true"
      >
        {/* Double-wide so we can slide left -50% */}
        <svg
          viewBox="0 0 1200 60"
        ...
        >
          ...
          {/* Second copy offset */}
          <path
            d="M1200 30 C1250 10, 1300 50, 1350 30 S1450 10, 1500 30 S1600 50, 1650 30 S1750 10, 1800 30 S1900 50, 1950 30 S2050 10, 2100 30 S2200 50, 2250 30 S2350 10, 2400 30 V60 H1200 Z"
            fill="rgba(0,236,151,0.06)"
          />
        </svg>
      </div>
      ...
      <div className="relative z-10" style={{ perspective: '1200px' }}>
        <div className="text-center space-y-6 sm:space-y-8">
          ...
          {/* Status line — intercepted signal */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      {/* ── Layer 7: Vignette overlay — void edges (darkened) ── */}
      <div
