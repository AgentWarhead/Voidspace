...
const BUILDER_MODULES: BuilderModule[] = [
  ...
  { slug: 'wallet-selector-integration', title: 'Wallet Connector Integration', description: 'Multi-wallet support with @hot-labs/near-connect — secure sandbox-based sign-in flows and transaction signing UX.', readTime: '50 min', order: 21 },
