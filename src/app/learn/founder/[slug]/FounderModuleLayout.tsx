        ...
        <Container size="lg">
          <div className="flex items-center justify-between py-3 gap-2">
            <nav className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-text-muted overflow-x-auto min-w-0">
              ...
              <ChevronRight className="w-3 h-3 flex-shrink-0" />
              <span className="text-purple-400 font-medium flex-shrink-0 hidden sm:inline">Founder Track</span>
              <span className="text-purple-400 font-medium flex-shrink-0 sm:hidden">Founder</span>
              <ChevronRight className="w-3 h-3 flex-shrink-0" />
      ...
      <div className="border-t border-border bg-surface/30">
        <Container size="lg">
          <div className="flex items-center justify-between py-4 sm:py-6 gap-2 sm:gap-4">
            {prevModule ? (
              <Link href={`/learn/founder/${prevModule.slug}`} className="group flex-1 max-w-[40%] sm:max-w-xs">
            ...
            {nextModule ? (
              <Link href={`/learn/founder/${nextModule.slug}`} className="group flex-1 max-w-[40%] sm:max-w-xs">
