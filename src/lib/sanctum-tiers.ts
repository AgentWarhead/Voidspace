...
export const SANCTUM_TIERS: Record<SanctumTier, SanctumTierConfig> = {
  shade: {
    ...
    features: [
      'Full Sanctum AI access',
      '$2.50 in credits — no strings attached',
      '6 starter templates',
      'All intelligence tools (free forever)',
    ],
    color: '#666666',
  ...
  specter: {
    name: 'Specter',
    tier: 'specter',
    tagline: 'For builders shipping real projects',
    monthlyPrice: 25,
    annualPrice: 250,
    creditsPerMonth: 25,
    features: [
      'Claude Opus 4 — the best AI model available',
      '$25/mo in credits (use it or lose it)',
  ...
  legion: {
    ...
    features: [
      ...
      '$70/mo in credits — 17% more value',
  ...
  leviathan: {
    name: 'Leviathan',
    tier: 'leviathan',
    tagline: 'For studios and serious operations',
    monthlyPrice: 200,
    annualPrice: 2000,
    creditsPerMonth: 230,
    features: [
      'Everything in Legion',
      '$230/mo in credits — 15% bonus built in',
      'Dedicated AI capacity (no queues, ever)',
